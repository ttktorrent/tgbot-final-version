...
This bot was TorToolKit
i just edited it to support heroku
if you like this support me by subcribing
this youtube channel https://youtu.be/eDjIyQ18L4E
# Easy Deploy 
fork this repo
Change Your Configs. Before Deploy Here  
Tortoolkit > Consts > ExecVarsSample.py
and click deploy button below
